...
end = datetime(2024, 11, 26, 12, 30)
runner = options_short.BacktestOptionShort(symbols, end, 90, day_diff, market_client, trading_client, option_client, polygon_client)
t = runner.run(False)
