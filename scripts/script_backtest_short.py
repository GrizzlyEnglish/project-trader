...
from src.helpers import get_data, features, class_model, short_classifier
...
for year in years:
    for info in symbol_info:
        ...
        for m in range(12):
            ...
            bars = class_model.get_model_bars(symbol, market_client, st, end, time_window, short_classifier.classification, look_back, look_forward, TimeFrameUnit.Minute)
            ...
            actual_labels = short_classifier.classification(pred_bars.copy(), look_forward)
